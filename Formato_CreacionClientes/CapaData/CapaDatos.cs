...
namespace Formato_CreacionClientes.CapaData
{
    ...
    public class Datos
    {
        ...
        static string conexion = @"Data Source= 10.252.0.158\Aliar;Initial Catalog=UNOEEALIAR;User Id=sa;Password=0bleaconMora";
